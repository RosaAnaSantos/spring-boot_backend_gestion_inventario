...
public class Controlador {
	...
	@PutMapping("/admin/{id}")
    ResponseEntity<Administrador> updateAdministrador(@Valid @RequestBody Administrador administrador) {
        Administrador admin= repoAdmin.save(administrador);
   ...
   // Delete Bitacora
    ...
    public Producto getProductoId(@PathVariable(value = "id") int id) { 
 	...
 	/*  @PostMapping("/producto")
 	    ResponseEntity<Producto> createProducto(@Valid @RequestBody Producto group) throws URISyntaxException {
 	        Producto result = repoProducto.save(group);
 	        return ResponseEntity.created(new URI("/rest/producto/" + result.getId()))
 	                .body(result);
 	    }
    */
 // Delete Producto
    ...
    ResponseEntity<Producto> updateProducto(@Valid @RequestBody Producto producto) {
        Producto product= repoProducto.save(producto);
 ...
 // Delete Categoria
	...
	// Update Usuario
	 ...
	 @PutMapping("/usuario/{id}")
	    ResponseEntity<Usuario> updateUsuario(@Valid @RequestBody Usuario usuario) {
	        Usuario user= repoUsuario.save(usuario);
