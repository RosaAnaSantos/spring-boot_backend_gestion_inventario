...
public class Producto implements Serializable {
	...
	public Producto(int id, String descripcion, String marca, String modelo, String nombre) {
		super();
		this.id = id;
		this.descripcion = descripcion;
		this.marca = marca;
	...
	public Producto(int id, String descripcion, String marca, String modelo, String nombre, Tipo tipoBean, List<Stock> stocks) {
		super();
		this.id = id;
		this.descripcion = descripcion;
		this.marca = marca;
